#!/usr/bin/env python3
"""
Export Compliance & Audit Tables

Exports all compliance and audit-related tables including:
- audit_logs
- change_events
- keystroke_logs
- notification_queue
...
Location: scripts/database_exports/export_compliance_audit.py
"""
...
EXPORT_DIR = "database_export/compliance_audit"
...
def export_tables():
    print("=" * 80)
    print("Compliance & Audit Data Export")
    print("=" * 80)
    print()
